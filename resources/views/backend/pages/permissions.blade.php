...
@section('page_header')
{{__('datatables.pages.permissions.header') }}
@endsection
...
<div class="col-md-12">
  <div class="card ">
    <div class="card-body ">
      <div class="row">
        <div class="col-md-12">
          <table class="table table-striped table-bordered responsive" id="permissionsdatatable-table">
...
@include('backend.modals.permissionsdatatable')
@include('backend.scripts.permissionsdatatable')
