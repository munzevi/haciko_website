...
@endpush
@section('page_header')
{{__('datatables.pages.tags.header') }}
@endsection
...
<div class="col-md-12">
  <div class="card ">
    <div class="card-body ">
      <div class="row">
        <div class="col-md-12">
          <table class="table table-striped table-bordered responsive" id="tagsdatatable-table">
...
@include('backend.modals.tagsdatatable')
@include('backend.scripts.tagsdatatable')
