...
@endsection
@section('page_header')
    {{__('filemanager.header')}}
@endsection
@section('content')
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header">
                <nav class="navbar sticky-top navbar-expand-lg" id="nav" style="background-color:#333844;border-radius:12px;">
...
{{--                    <a id="loading" class="navbar-brand"><i class="fas fa-spinner fa-spin"></i></a>--}}
                    <div class="ml-auto px-2">
                        <a class="navbar-link d-none" id="multi_selection_toggle">
                            ...
                            <p class="d-none d-lg-inline">{{ trans('laravel-filemanager::lfm.menu-multiple') }}</p>
                        </a>
                    </div>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-display="list">
                                    ...
                                    <p style="font-size:12px;">{{ trans('laravel-filemanager::lfm.nav-list') }}</p>
                                </a>
                            </li>
    ...
    <!--iframe src="/admin/filemanager" style="width: 100%; height:900px; border: none;"></iframe-->
